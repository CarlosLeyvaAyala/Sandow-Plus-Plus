%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is a help file intended to be released for this 
% mod's users.
% 
% This is a LaTeX file. You need to download any LaTeX 
% distribution to be able to compile and release this
% help document.
%
% It may look too complicated to download everything and
% learn YET ANOTHER computer language, but the results are
% well worth the pain.
% This document would take even longer to be done in Word
% or whatever.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
